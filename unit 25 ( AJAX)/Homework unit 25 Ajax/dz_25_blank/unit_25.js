...
function t1() {
    ...
    // let zap = '"';
    // zap += 'http://getpost.itgid.info/index2.php?';
    // const arr1 = {
...
function t2() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Vlad', true);
    xhttp.send();
    function myFunction(data) {
        console.log(data);
...
function t3() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=2&num2=6', true);
    xhttp.send();
    function myFunction(data) {
        console.log(data);
...
function t4() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=2&num2=9', true);
    xhttp.send();
    function myFunction(data) {
        console.log(data);
...
function t6() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=2&num2=8', true);
    xhttp.send();
    function myFunction(data) {
        console.log(data);
...
function t8() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1996', true);
    xhttp.send();
    function myFunction(data) {
        console.log(data);
...
function t11() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            myFun(this.responseText);
        }
    }
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Vlad', true);

    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Vlad');
    function myFun(data) {
        console.log(data);
        a = data;
...
function t12() {
    ...
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=1&num2=9');
    function myFun(data) {
        console.log(data);
        a = data;
...
function t13() {
    ...
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=1&num2=9');
    function myFun(data) {
        console.log(data);
        a = data;
...
function t15() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=3&num2=8', true);

    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=3&num2=8');
    function myFun(data) {
        console.log(data);
        a = data;
...
function t17() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1995', true);

    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1995');
    function myFun(data) {
        console.log(data);
        a = data;
...
function t18() {
    ...
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=99&m=1&d=1&y=1');
    function myFun(data) {
        console.log(data);
        a = data;
