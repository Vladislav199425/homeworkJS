...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=1&num2=9')
        .then(data => data.text())
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=1&num2=9')
        .then(data => data.text())
        .then(data =>
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=1&num2=9')
        .then(data => {
            return data.text();
        })
        .then(data =>
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1995')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t11() {
    fetch("http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Vladis", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
        },
        body: 'auth=zhrgB3DxC8LoG7Gcilzg&action=2&name=Vladis',
    })
        .then(response => response.text())
        .then(response => {
            console.log(response);
...
function t12() {
    fetch("http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=2&num2=8", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
        },
        body: 'auth=zhrgB3DxC8LoG7Gcilzg&action=3&num1=2&num2=8',
    })
        .then(response => response.text())
        .then(response => {
            console.log(response);
...
function t13() {
    fetch("http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=2&num2=8", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
        },
        body: 'auth=zhrgB3DxC8LoG7Gcilzg&action=4&num1=2&num2=8',
    })
        .then(response => response.text())
        .then(response => {
            console.log(response);
...
function t15() {
    fetch("http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=1&num2=7", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
        },
        body: 'auth=zhrgB3DxC8LoG7Gcilzg&action=6&num1=1&num2=7',
    })
        .then(response => response.text())
        .then(response => {
            console.log(response);
...
function t17() {
    fetch("http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1996", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
        },
        body: 'auth=zhrgB3DxC8LoG7Gcilzg&action=8&year=1996',
    })
        .then(response => response.text())
        .then(response => {
            console.log(response);
